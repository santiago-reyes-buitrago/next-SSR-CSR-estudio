'use client'
import {MenuItemSidebar} from "@/app/shared/components/Sidebar/MenuItemSidebar";
import { usePathname } from 'next/navigation'
import {menuItemsConstant} from "@/app/shared/core/constants/MenuItems.constant";




export const MenuSidebar = () => {
    const activedPath = usePathname()
    return (
        <div id="nav" className="w-full px-6">
            {menuItemsConstant.map(item => <MenuItemSidebar key={item.url} {...item} isActive={activedPath === item.url}/>)}
